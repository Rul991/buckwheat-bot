...
export const VOTE_TIME = MILLISECONDS_IN_SECOND * SECONDS_IN_MINUTE * MINUTES_IN_HOUR * HOURS_IN_DAY * 7
...
export const SAVE_COOLDOWN = MODE == 'dev' ? 1 : MILLISECONDS_IN_SECOND * SECONDS_IN_MINUTE * 10
export const MAX_STATS_SYMBOLS_COUNT = 5

export const DUEL_PRICE_PER_LEVEL = 10
